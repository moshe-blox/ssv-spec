...
//go:generate go run github.com/ferranbt/fastssz/sszgen --path beacon_types.go --include $GOPATH/pkg/mod/github.com/attestantio/go-eth2-client@v0.15.8/spec/phase0 --exclude-objs NetworkConfig,BeaconRole
