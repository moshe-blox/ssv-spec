...
func (r *ProposerRunner) expectedPreConsensusRootsAndDomain() ([]ssz.HashRoot, phase0.DomainType, error) {
	epoch := r.BaseRunner.NetworkConfig.EstimatedEpochAtSlot(r.GetState().StartingDuty.Slot)
...
func (r *ProposerRunner) executeDuty(duty *types.Duty) error {
	// sign partial randao
	epoch := r.GetBeaconNode().GetNetworkConfig().EstimatedEpochAtSlot(duty.Slot)
